...
<div class="card bg-opacity-20 bg-gray-600 border w-96 p-3 rounded-lg">
        ...
        <div class="card-detail bg-white rounded-r-lg px-3 flex flex-col justify-around">
            ...
            <div class="flex justify-between text-gray-600">
                <div class="flex gap-3">
                    <button class="minus border-2 border-grey-600"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
