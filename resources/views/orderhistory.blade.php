...
<div class="table-nav w-full mt-4">
    <div class="flex flex-col p-2 border rounded-md bg-black bg-opacity-40">
        <div class="flex flex-row justify-between text-white">
            ...
            <div class="w-1/6 hidden justify-center md:flex">Time Order</div>
            <div class="w-1/6 flex justify-center">Status</div>
            <div class="w-1/6 hidden justify-center md:flex">Time Response</div>
    ...
    <div class="flex flex-col divide-y-2">
        <div class="flex flex-row justify-between">
            ...
            <div class="w-1/6 flex justify-center content-start">
                    <p class="p-1 text-green-500">Accepted</p>
                </div>
            <div class="w-1/6 justify-center hidden md:flex items-center">12-12-21, 13.15</div>
            <div class="w-1/6 flex justify-center content-start">
                <button class="detail">
...
<div class="detailmodal hidden bg-black bg-opacity-50 absolute inset-0 items-center justify-center">
    ...
    <div class="flex flex-col">
        <div class="flex justify-between text-lg my-2">
            ...
            <p class="text-green-500 md:border border-green-500 py-1 px-2 rounded-lg">Accepted</p>
        ...
        <div class="flex justify-between my-2">
            <div class="flex">
                ...
                <p class="md:ml-3 md:border-none border md:px-0 px-2 rounded-lg border-gray-400">12-12-21, 13.00</p>
            </div>
            <div class="flex">
                <p class="font-medium hidden md:inline">Time response :</p>
                <p class="md:ml-3 md:border-none border md:px-0 px-2 rounded-lg border-gray-400">12-12-21, 13.15</p>
            </div>
        </div>
